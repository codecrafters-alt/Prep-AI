...
function Step2Interview({ interviewData, onFinish }) {
  ...
  useEffect(() => {
    ...
    const runIntro = async () => {
      if (isIntroPhase) {
        await speakText(
          `Hi ${userName}, I’ll be your AI interviewer today. Don’t worry, just be confident and answer honestly.`,
        );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0b0220] via-[#140633] to-[#02010a] flex items-center justify-center p-4 sm:p-6">
      {/* GRID BACKGROUND */}
      <div
    ...
    bg-emerald-500/10 rounded-full blur-[120px]"
      />
      <div
        className="w-full max-w-[1400px] min-h-[80vh] 
    ...
    flex flex-col lg:flex-row overflow-hidden"
      ...
      border-r border-purple-500/20"
        >
          ...
          bg-[#0f172a]/70 border border-purple-500/20 
          rounded-xl p-4 shadow-sm"
            >
              <p className="text-gray-300 text-sm sm:text-base font-medium text-center leading-relaxed">
                {subtitle}
              </p>
            </div>
          )}
        ...
        <div className="flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative">
         ...
         bg-purple-900/10 backdrop-blur-md 
          ...
          border border-purple-500/20 shadow-sm"
            >
              ...
              <div className="text-base sm:text-lg font-semibold text-gray-200 leading-relaxed">
          ...
          {!feedback ? (
            <div className="flex items-center gap-4 mt-6">
              ...
              text-black py-3 sm:py-4 rounded-2xl 
              shadow-lg shadow-emerald-500/30 
              hover:shadow-emerald-400/50 
              transition font-semibold disabled:bg-gray-700"
              >
           ...
           bg-purple-900/10 backdrop-blur-md 
            ...
            >
              <p className="text-emerald-400 font-medium mb-4">{feedback}</p>
